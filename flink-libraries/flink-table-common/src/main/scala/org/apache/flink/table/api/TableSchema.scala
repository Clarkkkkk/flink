...
class TableSchema(
  ...
  /**
    ...
    */
  def getFieldTypes: Array[TypeInformation[_]] = columnTypes
  ...
  /**
    ...
    */
  def getFieldType(columnIndex: Int): Optional[TypeInformation[_]] = {
    if (columnIndex < 0 || columnIndex >= columnNames.length) {
      Optional.empty()
    } else {
      Optional.of(columnTypes(columnIndex))
    }
  }
  ...
  /**
    ...
    */
  def getFieldType(columnName: String): Optional[TypeInformation[_]] = {
    if (columnNameToIndex.contains(columnName)) {
      Optional.of(columnTypes(columnNameToIndex(columnName)))
    } else {
      Optional.empty()
    }
  }
  ...
  /**
    ...
    */
  def getFieldCount: Int = columnNames.length

  /**
    * Returns all column names as an array.
    */
  def getFieldNames: Array[String] = columnNames

  /**
    * @deprecated Use { @link TableSchema#getFieldTypes()} instead. Can be dropped after 1.7.
    */
  @deprecated
  def getTypes: Array[TypeInformation[_]] = getFieldTypes
  ...
  /**
    ...
    */
  @deprecated
  def getColumnNames: Array[String] = getFieldNames
  ...
  /**
    ...
    * @param columnIndex the index of the field
    */
  def getFieldName(columnIndex: Int): Optional[String] = {
    if (columnIndex < 0 || columnIndex >= columnNames.length) {
      Optional.empty()
    } else {
      Optional.of(columnNames(columnIndex))
    }
  }
  ...
  def toRowType: TypeInformation[Row] = {
    Types.ROW_NAMED(getFieldNames, getFieldTypes: _*)
  }
